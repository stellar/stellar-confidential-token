...
\begin{protocol}[Distributed key generation]\label{prot:TshEG:KG}~
	...
	\begin{enumerate}
		...
		\item 	\commentni{Generates additive shares of  public key $E = e^{-1} \cdot H$}
		...
		\begin{enumerate}
			...
			\item Act as \Cc in $\tdDec$,  and verify the  decrypted value is $0$. \Inote{Hopefully, this check will catch if one of the parties misbehaves. Will see when we write the security proof.}
		\end{enumerate}
