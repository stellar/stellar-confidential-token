...
\newcommand{\rEqDef}
{
	\set{((\pk_0,\pk_1,\oA_0,\oA_1),(w_0,r_1))\colon   \KeyGen(w_0) = (\sk_0,\pk_0) \sland \Enc_{\pk_1}(\Dec_{\sk_0}(\oA_0);r_1)= \A_1}
}
...
\item[Operation:] ~
	...
	\begin{enumerate}
		...
		%	\item $\pi^\LrgEqs \getsr \pZK{\rLrgEq}((\pk_s,\oX_s,\oA_s),(x,r_s,r_b))$.
