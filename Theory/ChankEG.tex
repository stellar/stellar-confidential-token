...
\begin{algorithm}[ElGamal in-the-exponent encryption]\label{alg:EGinExp}~
...
\begin{algorithm}[Chunk ElGamal adaptively homomorphic encryption] \label{alg:ChunkEG}~
...
\subsection{ZK Proofs}\label{sec:ChanksEG:Proofs}
