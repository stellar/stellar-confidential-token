...
\begin{description}
	...
	\begin{description}
		...
		\item[Protocol:] %The sigma protocol for this relation concatenates, with the same challenge $e$ and answer $z$, two proofs of $\rEgEnc$. 
	\end{description}
	...
	\begin{description}
		...
		\item[Special soudness:] clear \Inote{verify}.
