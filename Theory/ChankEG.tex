...
\newcommand{\rEgEqDef}
{
	\set{((H,E_0,E_1,\tA_0,\tA_1),(e_0,r_1))\colon   e_0 \cdot G = E_0 \sland \wEgEnc_{H,E_1}(\wEgDec_{e_0}(\oA_0);r_1)= \A_1}
}
...
\begin{description}
	...
	\begin{description}
		...
		letting  $\wEgEnc_{H,E}(A;r) \eqdef (r\cdot E,r\cdot H + A)$ and $\wEgDec_e (\tA) \eqdef \tA_1- e\cdot \tA_0$. Namely, encryption and decryption of group elements. 
		
		
		%Letting  $\wEgEnc_{E}(A;r) \eqdef (r\cdot G,r\cdot E + A)$ and $\wEgDec_e (\tA) \eqdef \tA_1- e\cdot \tA_0$.
		
	
	
	
	\begin{protocol}[Equality proof]~
		
			\item[Common input:] $(H,E_0,E_1,\tA_0,\tA_1)$.
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\item Let $R_0' \asn R_0  + L_0 \cdot (e_0'- e_0) $.
					
				
				\item Let $A\asn \wEgDec_{e_0}(\oA_0)$.
				
					\item Sample $r'_1\getsr  \Z_q$.
					
				\item  Let  $\oA_1' \getsr \wEgEnc_{(H,E_1)}(A;r'_1)$.
				
				
			%	\item Let $L_0' \asn L_0 \cdot e_0^{-1}  \cdot  e_0'$.
	...
	\begin{description}
		...
		\item[Special soudness:] Let $(u,t^0,(e''_0)^0,(r''_1)^0)$ and  $(u,t^0,(e''_1)^1,(r''_1)^1)$, for $u \asn (E_0',R_0',\oA_1')$, be two accepting transcripts.
		
		\begin{enumerate}
			\item Let $e_0\asn ((e''_0)^1 -(e''_0)^0)/t$.  It is easy to verity  $e_0 \cdot G = E_0$.
			
				\item Let $r_1\asn ((r''_1)^1 -(r''_1)^0)/t$.  It is easy to verity  $\wEgEnc_{H,E_1}(\wEgDec_{e_0}(\oA_0)  =\oA_1$
