...
\newcommand{\rEgEqDef}
{
	\sset{((H,E_0,E_1,\tA_0,\tA_1),(e,r))\colon   e\cdot   G = E_0 \sland \wEgEnc_{(H,E_1)}(\wEgDec_{e}(\oA_0);r)= \A_1}
}
...
\begin{description}
	...
	\Inote{Give a version assuming knowledge of randomness.}
	...
	\begin{description}
		...
		\Inote{Smthg is weird about this part. How come $R_0' $ is unrestricted?}
	\end{description}
	\end{proof}
\end{description}
	\item[In range.] ~
